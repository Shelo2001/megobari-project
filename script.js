...
cardButton2.addEventListener('click', (e) => {
  document.querySelector('.review-cards').style.transform = 'translate(-350px)'
...
cardButton3.addEventListener('click', (e) => {
  document.querySelector('.review-cards').style.transform = 'translate(-700px)'
...
cardButton1.addEventListener('click', (e) => {
  document.querySelector('.review-cards').style.transform = 'translate(0px)'
